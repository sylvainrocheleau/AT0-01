...
def get_scrapeops_url(url, selector):
    payload = {'api_key': API_KEY, 'url': url, 'country': 'es', 'wait_for': selector, "render_js": True}
    proxy_url = 'https://proxy.scrapeops.io/v1/?' + urlencode(payload)
    return proxy_url

bookie_name = "RetaBetSO"
    ...
    def start_requests(self):
        for data in list_of_competitions:
            ...
            yield scrapy.Request(
                url=get_scrapeops_url(url=data["url"], selector="article.module__list-events"),
