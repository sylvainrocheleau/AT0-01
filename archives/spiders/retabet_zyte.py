...
class TwoStepsSpider(scrapy.Spider):
    ...
    custom_settings = {
        ...
        # "REQUEST_FINGERPRINTER_IMPLEMENTATION": "scrapy_playwright_ato.CustomRequestFingerprinter",
        # "ZYTE_API_FALLBACK_REQUEST_FINGERPRINTER_CLASS": "scrapy_playwright_ato.CustomRequestFingerprinter",
    }
    ...
    def raw_html(self, response):
        ...
        with open(parent + "/Scrapy_Playwright/scrapy_playwright_ato/" + bookie_name + "_response" + ".py", "w") as f:
