...
- The scripts in the folder scrapy_playwright_atos are used to scrape data and they run on Zyte Cloud.
...
- In scrapy_playwright_ato, there are scripts essential to Scrapy (items.py, pipelines.py and settings.py). The other scripts are as follow:
 - bookies_configurations.py: contains a list of market (list_of_markets_V2) and functions to get data on bookies and normalize odds
 ...
 - utilities.py: a set of functions frwquently used by the other scripts
...
- process_dutcher.py: processes statistics about odds
