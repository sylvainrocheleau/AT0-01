...
class TwoStepsSpider(scrapy.Spider):
        ...
        for data in bookie_config(self.name):
            ...
            try:
                yield scrapy.Request(
                    url="https://sb2frontend-altenar2.biahosted.com/api/Sportsbook/GetEvents?langId=4&skinName=casinogranmadrid&configId=1&culture=es-ES&countryCode=ES&integration=casinogranmadrid&withLive=false&group=AllEvents&champids=" + data["url"],
                    callback=self.match_requests,
                    meta=dict(
                        sport= data["sport"],
                        competition = data["competition"],
                        list_of_markets = data["list_of_markets"],
                        # true_competition_url = "https://sb2frontend-altenar2.biahosted.com/api/Sportsbook/GetEvents?langId=4&skinName=casinogranmadrid&configId=1&culture=es-ES&countryCode=ES&integration=casinogranmadrid&withLive=false&group=AllEvents&champids=" +
                        #                 data["url"],
                        playwright = True,
    ...
    async def match_requests(self,response):
        ...
        for match_info in match_infos:
            ...
            # if "https://sb2frontend-altenar2.biahosted.com/api/Sportsbook/GetEventDetails?langId=4&skinName=casinogranmadrid&configId=1&culture=es-ES&countryCode=ES&integration=casinogranmadrid&eventId=9848248" == match_info["url"]:
