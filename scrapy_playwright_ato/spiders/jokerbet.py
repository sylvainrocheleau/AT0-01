...
class TwoStepsSpider(scrapy.Spider):
        ...
        for data in bookie_config(self.name):
            ...
            try:
                yield scrapy.Request(
                    url="https://sb2frontend-altenar2.biahosted.com/api/Sportsbook/GetEvents?langId=4&skinName=jokerbet&configId=20&culture=es-es&countryCode=ES&integration=jokerbet&withLive=false&group=AllEvents&champids=" + data["url"],
    ...
    async def match_requests(self,response):
        ...
        for match_info in match_infos:
            ...
            # if "https://www.jokerbet.es/apuestas-deportivas.html#/sport/66/category/1178/championship/3709/event/9848248" == match_info["match_url"]:
