...
class TwoStepsSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        for data in bookie_config(self.name):
            ...
            yield scrapy.Request(
                url=data["url"].replace("csbgonline/home", "NavigationService/Home"),
    ...
    async def match_requests(self,response):
        ...
        for match_info in match_infos:
            ...
            # if match_info["url"] == "https://m.apuestas.codere.es/NavigationService/Game/GetGamesNoLiveByCategoryInfo?parentid=9777582470&categoryInfoId=99":
